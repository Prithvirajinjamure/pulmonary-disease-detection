...
UPLOAD_FOLDER = r'D:\Respiratory_Sound_Database\Respiratory_Sound_Database\AUDIOS'
os.makedirs(UPLOAD_FOLDER, exist_ok=True)
app.config['UPLOAD_FOLDER'] = UPLOAD_FOLDER

# Load pre-trained model
model = tf.keras.models.load_model(r'D:\Respiratory_Sound_Database\diagnosis_GRU_CNN_1.keras')
